...
#include <memory>
#include "../../Lab1/cryptocontroller.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CryptoController_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CryptoController_t qt_meta_stringdata_CryptoController = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CryptoController[] = {
...
Q_CONSTINIT const QMetaObject CryptoController::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_CryptoController.offsetsAndSizes,
    qt_meta_data_CryptoController,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CryptoController_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CryptoController, std::true_type>
    >,
    nullptr
} };
